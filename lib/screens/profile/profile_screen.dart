...
import 'search_history_screen_new.dart';
import '../settings/privacy_settings_screen_new.dart';
import '../settings/account_settings_screen_new.dart';
            ...
            child: Column(
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
                    Icon(Icons.phone_outlined, size: 16, color: Colors.white70),
                    const SizedBox(width: 6),
                    Text(
