...
function initializeFirebase() {
  ...
  try {
    ...
    console.warn('⚠️ Notifications will run in simulation mode');
  }
}
...
async function sendNotificationToUser(userId, eventData, fcmToken) {
  try {
    ...
    if (firebaseInitialized && admin && fcmToken) {
      ...
      console.log('📱 [SIMULATION] Notification would be sent:');
...
async function sendTopicNotification(topic, eventData) {
  try {
    ...
    if (firebaseInitialized && admin) {
      ...
      console.log(`📱 [SIMULATION] Topic notification: ${topic}`);
      console.log(`   Body: ${notificationText}`);
      return {
        success: true,
        simulation: true,
