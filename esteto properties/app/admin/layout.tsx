...
const sidebarItems = [
  ...
  { name: 'Account Requests', href: '/admin/account-requests', icon: Trash2 },
  ...
  const checkAdmin = async () => {
    ...
    try {
      ...
      if (response.success && response.data) {
        const userData = response.data as { id?: string; email?: string; name?: string; full_name?: string; role?: string }
        setUser({
          id: userData.id,
